# Linux Setup
Convolve AI has a setting up tutorial for linux [here](https://www.youtube.com/watch?v=YksCJ6v96eQ). Please follow if your OS is linux. Also, remember to pip install all the submodules and packages in environment.yml file manually.
